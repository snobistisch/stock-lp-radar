...
const rawPools: Omit<PoolOpportunity, "score" | "revertUrl">[] = [
  {
    ...
    ilEstimate30d: "1,5–4,0%", risk: "medium", riskReasons: ["Concentrated-liquidity range", "Aandelenprijs buiten markturen"],
    opportunityReason: "Diepste USDG-pool in de shortlist, met brede 30d-feevalidatie.", dataQuality: "verified",
  },
  {
    ...
    ilEstimate30d: "0,5–2,5%", risk: "low", riskReasons: ["Concentrated-liquidity range", "Issuer- en chainrisico"],
    opportunityReason: "Brede indexblootstelling, hoge actieve-TVL-ratio en consistente fee-opbrengst.", dataQuality: "verified",
  },
  {
    ...
    ilEstimate30d: "4–10%+", risk: "high", riskReasons: ["Private-market proxy", "Hoge meme-beta"],
    opportunityReason: "Sterke vraag en fee-efficiëntie, maar alleen passend bij een ruim risicobudget.", dataQuality: "verified",
  },
  {
    ...
    ilEstimate30d: "0,8–3,0%", risk: "medium", riskReasons: ["Korte poolhistorie", "Techconcentratie"],
    opportunityReason: "Goede liquiditeitsbenutting; de 30d-APR is nog een partiële observatie.", dataQuality: "partial-history",
  },
  {
    ...
    ilEstimate30d: "0,1–0,8%", risk: "medium", riskReasons: ["Zeer korte poolhistorie", "Dunne exitliquiditeit"],
    opportunityReason: "Lage verwachte prijsvolatiliteit, maar nog onvoldoende historie voor conviction.", dataQuality: "partial-history",
  },
  {
    ...
    ilEstimate30d: "1–3,5%", risk: "medium", riskReasons: ["Actieve TVL ontbreekt", "Concentrated-liquidity range"],
    opportunityReason: "Sterke meme-basisvraag; actieve liquiditeit moet vóór entry worden gecontroleerd.", dataQuality: "missing-active-tvl",
  },
  {
    ...
    ilEstimate30d: "0,5–2,0%", risk: "medium", riskReasons: ["APR-regime nog jong", "Hoge fee tier"],
    opportunityReason: "Hoge actieve-TVL-ratio en commodity-diversificatie; APR niet extrapoleren.", dataQuality: "partial-history",
  },
  {
    ...
    ilEstimate30d: "3–8%+", risk: "high", riskReasons: ["Twee volatiele assets", "Nacht- en weekendgap"],
    opportunityReason: "Veel omzet en fees, maar WETH maakt dit geen defensieve stock-LP.", dataQuality: "verified",
  },
  {
    ...
    ilEstimate30d: "1–4%", risk: "high", riskReasons: ["Extreme fee-APR", "Waarschijnlijk tijdelijk volumeregime"],
    opportunityReason: "Uitzonderlijke fee-efficiëntie, gemarkeerd als regime-anomalie in plaats van basiscase.", dataQuality: "verified",
  },
  {
    ...
    ilEstimate30d: "1–4%", risk: "medium", riskReasons: ["Relatief dunne TVL", "Concentrated-liquidity range"],
    opportunityReason: "Volwassen pool met vrijwel volledig actieve TVL; sizing blijft belangrijk.", dataQuality: "verified",
  },
];
