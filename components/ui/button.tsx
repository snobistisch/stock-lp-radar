...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-lg text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-primary px-4 py-2.5 text-black hover:bg-primary/85",
        outline: "border border-border bg-white/[0.02] px-4 py-2.5 text-foreground hover:bg-white/[0.06]",
        ghost: "px-3 py-2 text-muted hover:bg-white/[0.05] hover:text-foreground",
      },
